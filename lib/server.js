  ...
  requestParser.parse(request)
    .then(request => {
      ...
      if(request.method === 'GET' && request.url.pathname === '/cowsay'){
        ...
        let responseObject = {
          content: cowsay.say({text: request.body.text}),
        };
